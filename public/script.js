...
const allItems = document.querySelectorAll("#instructionBox li");
allItems.forEach(li => li.classList.remove("active-gesture"));

// ===== MATCH ALL STATIC =====
if (finalOutput.includes("Hello")) document.getElementById("g-hello")?.classList.add("active-gesture");
if (finalOutput.includes("Yes")) document.getElementById("g-yes")?.classList.add("active-gesture");
if (finalOutput.includes("No")) document.getElementById("g-no")?.classList.add("active-gesture");
if (finalOutput.includes("Peace")) document.getElementById("g-peace")?.classList.add("active-gesture");
if (finalOutput.includes("Point")) document.getElementById("g-point")?.classList.add("active-gesture");
if (finalOutput.includes("Fist")) document.getElementById("g-fist")?.classList.add("active-gesture");

if (finalOutput.includes("Four")) document.getElementById("g-four")?.classList.add("active-gesture");
if (finalOutput.includes("Three")) document.getElementById("g-three")?.classList.add("active-gesture");
if (finalOutput.includes("Two")) document.getElementById("g-two")?.classList.add("active-gesture");
if (finalOutput.includes("One")) document.getElementById("g-one")?.classList.add("active-gesture");

if (finalOutput.includes("Rock")) document.getElementById("g-rock")?.classList.add("active-gesture");
if (finalOutput.includes("Love")) document.getElementById("g-ily")?.classList.add("active-gesture");
if (finalOutput.includes("Call")) document.getElementById("g-call")?.classList.add("active-gesture");
if (finalOutput.includes("Gun")) document.getElementById("g-gun")?.classList.add("active-gesture");

if (finalOutput.includes("OK")) document.getElementById("g-ok")?.classList.add("active-gesture");
if (finalOutput.includes("Pinch Middle")) document.getElementById("g-pinchM")?.classList.add("active-gesture");
if (finalOutput.includes("Pinch Ring")) document.getElementById("g-pinchR")?.classList.add("active-gesture");
if (finalOutput.includes("Pinch Pinky")) document.getElementById("g-pinchP")?.classList.add("active-gesture");

if (finalOutput.includes("Disagree")) document.getElementById("g-disagree")?.classList.add("active-gesture");
